      ...
      {loading ? (
        ...
        <div className="max-w-3xl w-full rounded-xl shadow-xl bg-white overflow-hidden p-10 md:p-16 relative">
          ...
          <section className="mb-10 animate-slide-up">
            <h2 className="text-3xl font-bold font-Adu text-primary mb-5">
              Our Mission
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed ">
              Our mission is to provide our readers with high-quality content on
              a variety of topics, crafted by a community of passionate authors.
              We believe in the power of storytelling to connect people and
          ...
          <section className="animate-slide-up">
            <h2 className="text-3xl font-bold text-primary mb-5 font-Adu">
              Our Authors
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-8 ">
              Meet our dedicated authors who actively contribute to our
              platform. These talented individuals have shared insightful
              articles to engage and inform our readers.
            </p>
            ...
            {users.map((user, index) => (
              ...
              >
                <div className="  flex items-center justify-center w-16 h-16 rounded-full object-fill  overflow-hidden border-4 border-primary-dark shadow-lg">
                  <Image
                    src={
                    ...
                    alt={user.username}
                    width={400} // Match the div width
                    height={400} // Match the div height
                    quality={75}
                    objectFit="fill"
                    className="object-cover flex items-center justify-center" // Ensures the image covers the div
                  />
                </div>
